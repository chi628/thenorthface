...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function tmp(id) {
    const obj = badgeList.find(badge => badge.id === id)
    console.log('obj', obj)
